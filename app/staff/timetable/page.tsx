...
export default async function StaffTimetable() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 px-8 py-8">
        ...
        <p className="text-sm text-gray-500 mb-8">Weekly class schedule</p>
            ...
            return (
              <div key={day} className="bg-white rounded-2xl border overflow-hidden">
                <div className="px-6 py-3 bg-green-50 border-b">
                  <h2 className="text-sm font-semibold text-green-700">{day}</h2>
                </div>
                {dayEntries.length === 0 ? (
                  ...
                  <table className="w-full text-sm">
                    <thead className="border-b">
                      <tr>
                        ...
                        <th className="text-left px-6 py-2 text-gray-500 font-medium">Class</th>
                    ...
                    <tbody>
                      {dayEntries.map(t => (
                        <tr key={t.id} className="border-b last:border-0 hover:bg-gray-50">
                          ...
                          <td className="px-6 py-3 text-gray-500">{t.className}</td>

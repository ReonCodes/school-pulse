...
export default function StudentLogin() {
  ...
  className="border border-gray-200 rounded-lg px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-500 text-gray-900 bg-white"
/>
  ...
  className="border border-gray-200 rounded-lg px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-blue-500 w-full pr-10 text-gray-900 bg-white"
/>
  <button
    type="button"

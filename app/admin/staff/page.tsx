    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-gray-800 mb-1">Staff</h1>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="text-left px-6 py-3 text-gray-500 font-medium">Staff No</th>
              ...
              {staffList.length === 0 ? (
                ...
                staffList.map(s => (
                  <tr key={s.id} className="border-b last:border-0 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-gray-500">{s.staff?.staffNo ?? '—'}</td>
                    <td className="px-6 py-4 text-gray-500">{s.staff?.subject ?? '—'}</td>
